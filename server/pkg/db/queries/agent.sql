...
VALUES (
    $1, $2, $3, $4, CASE WHEN sqlc.narg(fire_at)::timestamptz IS NULL THEN 'queued' ELSE 'deferred' END, $5, sqlc.narg(trigger_comment_id),
...
-- name: CountActiveAgentTasksByWorkDir :one
...
-- name: SelectRelayStageRerunAgent :one
