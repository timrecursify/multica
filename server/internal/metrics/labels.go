...
var businessMetricLabels = map[string][]string{
	...
	"multica_dispatch_admission_admitted_total":   {labelClass},
	"multica_dispatch_admission_deferred_total":   {labelClass},
	"multica_dispatch_admission_rejected_total":   {labelClass},
	"multica_dispatch_admission_near_limit_total": {labelClass},
