...
\restrict ewcctROaDVBtkhQNq7oidXRpTczPudz62DGUDnOTYkFAMNXwgld9fhZQPmA6Yiu
...
CREATE TABLE public.qc_review_card (
    ...
    CONSTRAINT qc_review_card_verdict_check CHECK (((verdict)::text = ANY ((ARRAY['pass'::character varying, 'fail'::character varying])::text[])))
);
