...
| `ops/gsp-belt/scripts/belt-completion-liveness.cjs` `ops/gsp-belt/scripts/belt-completion-metrics.cjs` | `/usr/local/libexec` | completion liveness evaluator and authoritative metrics adapter | Invoked by belt-status when BELT_COMPLETION_STALL_WINDOW is configured |
