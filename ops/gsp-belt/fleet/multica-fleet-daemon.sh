...
export CODEX_BIN="${CODEX_BIN:-/home/newadmin/tools/codex-openrouter}"
...
export MULTICA_WORKSPACES_ROOT="${GSP_WORKSPACES_ROOT:-/home/newadmin/multica-workspaces-gsp}"
