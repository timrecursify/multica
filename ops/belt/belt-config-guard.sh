...
# Empty values are invalid rather than defaults: accepting one would silently
# widen capacity or direct workspaces to an unexpected root.
...
# 1. Tower concurrency and root must remain PM2-configurable.
guard_wrapper() {
