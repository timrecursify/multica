...
module.exports = {
  apps: [
    ...
    { name: 'gsp-multica-worker', script: '/home/newadmin/gsp-multica/fleet/multica-daemon-wrapper.sh', ...guardrails, kill_timeout: 30000,
      env: { MULTICA_DAEMON_MAX_CONCURRENT_TASKS: process.env.MULTICA_DAEMON_MAX_CONCURRENT_TASKS, MULTICA_DAEMON_WORKSPACES_ROOT: process.env.MULTICA_DAEMON_WORKSPACES_ROOT ?? '/home/newadmin/multica-workspaces-gsp', BELT_SOURCE_ROOT: process.env.BELT_SOURCE_ROOT ?? '/home/newadmin/multica/ops/belt' } },
  ],
};
