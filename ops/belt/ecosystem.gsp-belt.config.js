...
module.exports = {
  apps: [
    ...
    { name: 'multica-cicd-worker', script: path.join(__dirname, 'multica-cicd-worker.cjs'), ...guardrails },
    { name: 'multica-archiver', script: path.join(__dirname, 'multica-archiver.cjs'), ...guardrails },
    ...
    { name: 'gsp-multica-worker', script: process.env.BELT_WORKER_SCRIPT ?? path.join(__dirname, 'multica-daemon-wrapper.sh'), ...guardrails, kill_timeout: 30000,
