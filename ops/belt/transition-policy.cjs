...
const TRANSITIONS = Object.freeze([
  ...
  ['Spec', 'Human Review', ['system', 'operator'], 'review'],
  ['Queue', 'Human Review', ['system', 'operator'], 'review'],
  ['In Progress', 'Human Review', ['system', 'operator'], 'review'],
  ['In Review', 'Human Review', ['system', 'operator'], 'review'],
  ['CI/CD & Deploy', 'Human Review', ['system', 'operator'], 'review'],
