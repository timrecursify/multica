...
test("recordStageOutcomes stores production outcomes under source stage", async () => {
  const c = fakeClient([[{ id: "t1", issue_id: "i1", stage: "In Progress", target_stage: "In Review", output: "OUTCOME: FAILED" }], [{ input_hash: "h" }], []]);
