...
[[ "$(sed -n '1p' "$tmp/pm2.log")" == '0 0' && "$(sed -n '2p' "$tmp/pm2.log")" == save ]]
...
[[ "$(sed -n '3p' "$tmp/pm2.log")" == '1 1' && "$(sed -n '4p' "$tmp/pm2.log")" == save ]]
