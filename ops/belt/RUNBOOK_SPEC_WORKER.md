...
python3 ops/belt/multica-bundle.py --mega <existing-mega-number> --apply
```
...
4. Fold the children in and hide them:
   ...
   ```bash
   python3 ops/belt/multica-bundle.py --mega <mega-number> --apply
   ```
...
- If not, the mega is a bucket. Split it before specifying: create narrower
  ...
  ```bash
  python3 ops/belt/multica-bundle.py --unbundle <ticket-number> --apply
  python3 ops/belt/multica-bundle.py --mega <new-mega-number> --apply
  ```
