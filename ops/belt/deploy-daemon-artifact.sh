...
target="${MULTICA_DAEMON_TARGET:-/var/lib/gsp/multica-daemon/server}"; pm2_bin="${PM2_BIN:-pm2}"; proc_root="${PROC_ROOT:-/proc}"; app="${MULTICA_DAEMON_PM2_APP:-gsp-multica-worker}"
