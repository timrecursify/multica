...
| `multica-bundle.py` | `/var/lib/gsp/tools/multica-bundle.py` | Stable belt runtime helper |
...
as `python3 /var/lib/gsp/tools/multica-bundle.py` from any managed workspace.
