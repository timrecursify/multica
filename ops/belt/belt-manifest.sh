...
declare -a sources=(
  ...
  "$root_dir/guardrails.cjs"
  "$root_dir/human-review-routing.cjs"
  "$root_dir/human-review-routing.cjs"
  "$root_dir/astra-adjudication.cjs"
  "$root_dir/astra-adjudication.cjs"
  ...
  "$root_dir/RUNBOOK_ASTRA_ADJUDICATOR.md"
...
declare -a targets=(
  ...
  "$runtime_root/gsp-multica-bridge/human-review-routing.cjs"
  "$runtime_root/multica-relay-advance/app/human-review-routing.cjs"
  "$runtime_root/gsp-multica-bridge/astra-adjudication.cjs"
  "$runtime_root/multica-relay-advance/app/astra-adjudication.cjs"
  ...
  "$doctrine_root/RUNBOOK_ASTRA_ADJUDICATOR.md"
