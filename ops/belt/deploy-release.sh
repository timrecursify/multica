...
manifest=(ops/belt/multica-bridge.cjs ops/belt/guardrails.cjs ops/belt/parked-diagnosis.cjs ops/belt/parked-entry-audit.cjs ops/belt/parity/multica-relay-advance-daemon.cjs ops/belt/parity/relay-dead-rows.cjs ops/belt/multica-cicd-worker.cjs ops/belt/github-token.cjs ops/belt/cicd-watchdog.cjs ops/belt/cicd-deploy-evidence.cjs ops/belt/multica-archiver.cjs ops/belt/reconciler.cjs ops/belt/stage-outcome.cjs ops/belt/transition-policy.cjs ops/belt/stage-routing.cjs ops/belt/qc-strict-evidence.cjs ops/belt/qc-verdict-policy.cjs ops/belt/belt-config-guard.sh ops/belt/multica-daemon-wrapper.sh ops/belt/ecosystem.gsp-belt.config.js ops/belt/multica-bundle.py ops/belt/RUNBOOK_SPEC_WORKER.md ops/belt/RUNBOOK_BUILD_WORKER.md ops/belt/RUNBOOK_QC_WORKER.md ops/belt/WORKER_COMMON.md ops/belt/relay-completion-admission.cjs ops/gsp-belt/relay/multica-relay-advance-launcher.cjs ops/gsp-belt/relay/multica-relay-advance-wrapper.sh ops/gsp-belt/relay/multica-relay-advance-daemon.cjs)
health() {
  local snapshot
