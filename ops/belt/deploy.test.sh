...
declare -a files=('gsp-multica/multica-bridge.cjs' 'gsp-multica/guardrails.cjs' 'gsp-multica/parked-diagnosis.cjs' 'gsp-multica/parked-entry-audit.cjs' 'gsp-multica/parity/multica-relay-advance-daemon.cjs' 'gsp-multica/parity/relay-dead-rows.cjs' 'gsp-multica/stage-routing.cjs' 'gsp-multica/stage-routing.json' 'gsp-multica/qc-strict-evidence.cjs' 'gsp-multica/qc-lane.cjs' 'gsp-multica/reconciler.cjs' 'gsp-multica/stage-outcome.cjs' 'gsp-multica/transition-policy.cjs' 'gsp-multica/qc-verdict-policy.cjs' 'multica-cicd-worker.cjs' 'cicd-deploy-evidence.cjs' 'multica-archiver.cjs' 'tools/belt-config-guard.sh' 'gsp-multica/fleet/multica-daemon-wrapper.sh' 'gsp-multica/fleet/ecosystem.gsp-belt.config.js' 'tools/multica-bundle.py' 'multica-doctrine/RUNBOOK_SPEC_WORKER.md' 'multica-doctrine/RUNBOOK_BUILD_WORKER.md' 'multica-doctrine/RUNBOOK_QC_WORKER.md' 'multica-doctrine/WORKER_COMMON.md' 'gsp-multica/relay-completion-admission.cjs')
declare -a sources=('ops/belt/multica-bridge.cjs' 'ops/belt/guardrails.cjs' 'ops/belt/parked-diagnosis.cjs' 'ops/belt/parked-entry-audit.cjs' 'ops/belt/parity/multica-relay-advance-daemon.cjs' 'ops/belt/parity/relay-dead-rows.cjs' 'ops/belt/stage-routing.cjs' 'ops/belt/stage-routing.json' 'ops/belt/qc-strict-evidence.cjs' 'ops/belt/qc-lane.cjs' 'ops/belt/reconciler.cjs' 'ops/belt/stage-outcome.cjs' 'ops/belt/transition-policy.cjs' 'ops/belt/qc-verdict-policy.cjs' 'ops/belt/multica-cicd-worker.cjs' 'ops/belt/cicd-deploy-evidence.cjs' 'ops/belt/multica-archiver.cjs' 'ops/belt/belt-config-guard.sh' 'ops/belt/multica-daemon-wrapper.sh' 'ops/belt/ecosystem.gsp-belt.config.js' 'ops/belt/multica-bundle.py' 'ops/belt/RUNBOOK_SPEC_WORKER.md' 'ops/belt/RUNBOOK_BUILD_WORKER.md' 'ops/belt/RUNBOOK_QC_WORKER.md' 'ops/belt/WORKER_COMMON.md' 'ops/belt/relay-completion-admission.cjs')
