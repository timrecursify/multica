...
install -d -m 0755 /etc/gsp /usr/local/bin /etc/systemd/system/gsp-backup-age-emitter.service.d
...
install -o root -g root -m 0644 "$root/gsp-backup-age-emitter.timer" /etc/systemd/system/gsp-backup-age-emitter.timer
install -o root -g root -m 0644 "$root/gsp-backup-age-emitter.service.d/onfailure-sink.conf" /etc/systemd/system/gsp-backup-age-emitter.service.d/onfailure-sink.conf
